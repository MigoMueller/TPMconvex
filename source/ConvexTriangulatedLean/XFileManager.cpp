...
// default parameter to ctor
// maximum #XFiles kept in RAM at the same time
const unsigned int XFileManager::DefaultMaxN = 100;
...
void XFileManager::push_back(unsigned int blueness)
{
	...
	{
		ostringstream dummy;
		dummy<<directory<<'/'<<bluenessList.filename(blueness)<<ends;
