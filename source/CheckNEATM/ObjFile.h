...
// BUG:
// Memory leaks may arise if a corrupted / non-existing file is read in.
// Reason: ctor throws exceptions without appropriately handling them.
// What to do:
// Implement some try-catch blocks in ctor to release memory already allocated.
// PRIORITY: low... (only relevant if many obj-files are read in)
// [this might happen in a GUI!]
