...
int main(int nargs, char* argsv[])
{
  if (nargs != 5)
    {
      cerr<<"CC_PUI, calculate PUI color-correction factors for NEATM-like spectra"<<endl;
  ...
  cerr<<"# PUI color-correction factors for NEATM spectrum with following parameters:"<<endl;
